...
do
    ...
    do
        ...
        do
            ...
            for collective in allreduce
            do
                python3 ./plot/heatmap.py --system ${system} --collective ${collective} --tasks_per_node 1 --metric ${metric} --base ${base} ${extra_params} --nnodes 4,8,16,32,64,128,256,512,1024,2048 --exclude "segmented"
