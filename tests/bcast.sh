...
export LIB_0_BCAST_ALGORITHMS="linear_over,binomial_halving_over,binomial_doubling_over,scatter_allgather_over"
export LIB_0_BCAST_ALGORITHMS_SKIP="scatter_allgather_over"
export LIB_0_BCAST_ALGORITHMS_IS_SEGMENTED="no,no,no,no"
