...
export LIB_0_ALLREDUCE_ALGORITHMS="bine_lat_mpich,bine_bdw_mpich,bine_lat_over,bine_bdw_remap_segmented_over"
export LIB_0_ALLREDUCE_ALGORITHMS_SKIP="bine_lat_mpich,bine_bdw_mpich,bine_bdw_remap_segmented_over"
export LIB_0_ALLREDUCE_ALGORITHMS_IS_SEGMENTED="no,no,no,yes"
export LIB_0_ALLREDUCE_ALGORITHMS_CVARS="bine_lat,bine_bdw,auto,auto"
export LIB_0_ALLREDUCE_ALGORITHMS_BINE_IMPS="none,none,none,none"
