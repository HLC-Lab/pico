...
int allgather_bine_block_by_block_hierarcic_local_global(ALLGATHER_MPI_ARGS);
int allgather_bine_block_by_block_hierarcic_global_local(ALLGATHER_MPI_ARGS);
int allgather_bine_send_remap_hierarcic_local_global(ALLGATHER_MPI_ARGS);
int allgather_bine_send_remap_hierarcic_global_local(ALLGATHER_MPI_ARGS);
int allgather_bine_2_blocks_hierarcic(ALLGATHER_MPI_ARGS);
int allgather_bine_permutation_hierarcic_local_global(ALLGATHER_MPI_ARGS);
int allgather_bine_permutation_hierarcic_global_local(ALLGATHER_MPI_ARGS);
...
int reduce_scatter_bine_permute_remap_hierarchical_v1(REDUCE_SCATTER_MPI_ARGS);
int reduce_scatter_bine_permute_remap_hierarchical_v2(REDUCE_SCATTER_MPI_ARGS);
...
int reduce_scatter_bine_block_by_block_hierarchical_v1(REDUCE_SCATTER_MPI_ARGS);
